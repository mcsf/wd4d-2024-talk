...
console.warn(
`NOTE: The 'Date as a Paragraph' variation doesn't work as of WordPress 6.7,
nor Gutenberg 19.8. The reason is that block bindings, as of their current
implementation, are implemented using standard WordPress hooks, making them
inaccessible to third parties which are themselves using the
'editor.BlockEditor' hook. This will be fixed once the following pull request
is merged:
